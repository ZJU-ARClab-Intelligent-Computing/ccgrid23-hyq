...
def plot_iops_with_rate(cpu_loads, fio_perfs, fig_path, iops_requirements={}, suffix_name=""):
    iops_requirements = {**iops_requirements, "blocksize": {"4k"}, "cpunum": {96}}
...
def plot_rw_qd(cpu_loads, fio_perfs, fig_path):
    ...
    plot_iops_with_rate(cpu_loads, fio_perfs, fig_path, { "scheme": {"Non-offloading", "Offloading"} }, "_without_HyQ")
